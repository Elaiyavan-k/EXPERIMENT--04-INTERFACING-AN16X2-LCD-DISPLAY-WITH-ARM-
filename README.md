...
int main(void)
{
  ...
  Lcd_string(&lcd, "Elaiyavan K");
  HAL_Delay(1000);

  Lcd_cursor(&lcd, 1, 0);     // row 1, col 0
  Lcd_string(&lcd, "212224100015");
  HAL_Delay(1000);
...
## Output screen shots of proteus  :
 <img width="1400" height="984" alt="Screenshot 2025-09-22 142548" src="https://github.com/user-attachments/assets/301ea55f-2f5a-41d3-a712-90e7efb4fb12" />

 
## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="1348" height="943" alt="image" src="https://github.com/user-attachments/assets/2ebf1dd0-8b73-4947-9c35-0fb354cfabb3" />
